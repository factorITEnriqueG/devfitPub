<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="factorit-demo-center.aspx.cs" Inherits="FactotIT_DemoCenter.main.factorit_demo_center" %>
...
<head>
  ...
  <title>FACTOR IT DEMO CENTER. </title>
...
<body>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Home</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="index.html" class="active"> Home - index.html</a></li>
  ...
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      ...
      <h2>Welcome DEVELOPER PRODUCCION  to <span>HeroBiz</span></h2>
